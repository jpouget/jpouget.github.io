...
[![Join us]({{ '/images/join-us-rainbow.png' | relative_url }})](mailto:jennie.pouget@camh.ca?subject=Joining%20the%20Pouget%20Lab)
...
{%
  ...
  image="images/genetics-rainbow-icon.png"
  link="research"
  title="Our Research"
  text=text
%}
...
{%
  include feature.html
  image="images/team-rainbow-icon.png"
  link="team"
  title="Our Team"
  text=text
%}
